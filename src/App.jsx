...
function App() {
  ...
  return (
    ...
    <div id="content4" className="text-dark text-center m-5">
      ...
      {/* <div id="carouselExampleSlidesOnly" className="carousel slide mt-5 text-center" data-bs-ride="carousel">
        <div className="carousel-inner">
          <div className="carousel-item active">
            <Image src={cafe1} className="d-block w-100" alt="..."/>
          </div>
          <div className="carousel-item">
            <Image src={cafe2} className="d-block w-25" alt="..."/>
          </div>
          <div className="carousel-item">
            <Image src={cafe3} className="d-block w-25" alt="..."/>
          </div>
        </div>
      </div> */}
